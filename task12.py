class BankAccount:
    ...
    def check_pin(self):
        entered_pin_for_open_acc = int(input("Enter 4 digit pin for watching acc details : "))
        if entered_pin_for_open_acc == self.pin:
    ...
    def deposit(self,dep_amount):
        entered_pin_for_deposite = int(input("enter the 4 digit pin for deposite cash : "))
    ...
    def withdraw(self,withdraw_amount):
        entered_pin_for_withdraw = int(input("enter the 4 digit pin for withdraw cash :"))
