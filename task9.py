...
# will give us list of the intervals which considerd night times
night_dates = []
...
#it will make an list of interval which is common in main interval and night interval so that we can get an intervals which gives us final hours which will be removed from the total time
time_after_difference = [start_end_interval & interval for interval in night_dates]
